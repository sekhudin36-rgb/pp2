  ...
  return (
    <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-500 h-full flex flex-col relative">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 shrink-0 mt-2 mb-4">
        <div>
          <h1 className="text-3xl font-bold text-slate-50 tracking-tight">Data Anggota</h1>
          <p className="text-sm text-slate-400 mt-1">Daftar siswa/guru yang terdaftar</p>
        </div>
      ...
      <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl overflow-hidden flex flex-col flex-1">
        <div className="px-8 py-5 border-b border-white/10 flex justify-between items-center sm:flex-row flex-col gap-4">
          <div className="flex flex-col sm:flex-row gap-4 w-full">
            <div className="relative w-full sm:w-72">
              ...
              <input 
                ...
                placeholder="Cari anggota berdasarkan nama/email..." 
                className="w-full pl-9 pr-4 py-2 text-sm bg-slate-900/50 border border-white/10 rounded-xl focus:outline-none focus:ring-2 focus:ring-emerald-500/50 text-slate-50 placeholder-slate-400 transition-all"
              />
            </div>
            <select 
              value={filterYear} 
              onChange={e => setFilterYear(e.target.value)}
              className="px-4 py-2 bg-slate-900/50 border border-white/10 rounded-xl focus:ring-2 focus:ring-emerald-500/50 text-sm text-slate-200 outline-none"
            >
          ...
          <button onClick={openAddModal} className="px-4 py-2 bg-emerald-500 hover:bg-emerald-600 text-white text-xs font-bold rounded-lg transition-colors whitespace-nowrap flex items-center shrink-0">
